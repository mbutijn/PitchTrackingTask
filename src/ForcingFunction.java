...
public class ForcingFunction {
    ...
    int duration, numberSamples, sampleFrequency;
    ...
    public double[] makefunction() {
        Linspace timeProperties = new Linspace(0, duration, numberSamples);
        double[] time = new double[numberSamples];
        time[0] = 0;
        ...
        double omega_m = 2*Math.PI / 81.92; // ~ 0.0767 rad/s

        double[][] matrix = new double[][]{{1,  6,    0.460, 1.397, 1.288,   5, 0.383, 0.601, -2.069},
